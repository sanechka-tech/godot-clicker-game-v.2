...
const DIALOG_LINES := [
	{"name": "HERO_LEKS", "story": "STORY_LVL3_INTRO_006"},
	{"name": "HERO_LEKS", "story": "STORY_LVL3_INTRO_007"},
	{"name": "HERO_LEKS", "story": "STORY_LVL3_INTRO_008"},
]
...
func _show_current_line() -> void:
	...
	if story_key == "STORY_LVL3_INTRO_007":
...
func _change_to_next_scene() -> void:
	...
	AudioManager.play_level_3_intro_close_the_door()
