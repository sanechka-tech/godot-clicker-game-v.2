...
const NEXT_SCENE_PATH := "res://cutscenes/lvl_1_2_call_intro.tscn"
...
@onready var bg_leks: TextureRect = $"BG Leks"
@onready var bg_leks_error: TextureRect = $"BG Leks(error)"

var _bg_room_player: AudioStreamPlayer
var _name_key := ""
var _story_key := ""
...
func _ready() -> void:
	...
	bg_leks.visible = true
	bg_leks_error.visible = false
...
func _play_intro_sequence() -> void:
	...
	_bg_room_player = AudioManager.play_level_1_intro_bg_room()
...
func _change_to_next_scene() -> void:
	...
	if transition_screen != null:
		_fade_bg_room(NEXT_SCENE_AUDIO_FADE_OUT_DURATION)
		transition_screen.change_scene(NEXT_SCENE_PATH)
	else:
		get_tree().change_scene_to_file(NEXT_SCENE_PATH)


func _fade_bg_room(duration: float) -> void:
